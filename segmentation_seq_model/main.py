...
def get_args():
    ...
    parser.add_argument("--data_dir", type=str, default="./data", help="데이터셋 루트 경로")
    parser.add_argument("--train_img", type=str, default="train/images", help="학습 이미지 폴더명")
    parser.add_argument("--train_mask", type=str, default="train/masks", help="학습 마스크 폴더명")
    ...
    parser.add_argument("--model_name", type=str, default="unet", help="unet, deeplabv3 등")
...
def main():
    ...
    dir_path = (
        "/home/hyeonjun/Downloads/isaac-sim-standalone-5.1.0-linux-x86_64/_melon_dataset/train"
    )
    ...
    # torch.load(check_point_path, map_location=device), strict=False
    # )
